...
public class MenuActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void permission() {
        if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(MenuActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_CODE);
    ...
    public ArrayList<MusicFiles> getAllAudio(Context context) {
        ...
        {
            case "sortByName":
                Order = MediaStore.MediaColumns.DISPLAY_NAME + " ASC"; // ngồi cả sáng để fix 1 dấu backspace
                break;
